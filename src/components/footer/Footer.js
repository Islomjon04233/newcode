        ...
        <div id="footer" className="site-footer js-site-footer" role="contentinfo">
            <div className="container-large">
                <div className="footer-main-content">
                    <div>
                        <a href="/">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 24" role="img" aria-labelledby="akm4ysxkrmo3q83pvfd76x3lcey12u0b" className="icon dribbble-wordmark">
                                <title id="akm4ysxkrmo3q83pvfd76x3lcey12u0b">Dribbble: the community for graphic design
                                </title>
                        ...
                        <div className="social-links-container">
                            ...
                            <a href="http://facebook.com/dribbble">
                                <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="aoq5tve5sc1dtyvl77csludupgc2b98q" role="img" viewBox="0 0 24 24" className="icon fill-current">
                                    <title id="aoq5tve5sc1dtyvl77csludupgc2b98q">Facebook icon</title>
                            ...
                            <a href="http://instagram.com/dribbble">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="1.414" role="img" className="icon fill-current">
                            ...
                            <a href="http://www.pinterest.com/Pinner13145726/">
                                <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="ambrpf0sbuebelnpx9evjxd7t076x4yv" role="img" viewBox="0 0 24 24" className="icon fill-current">
                                    <title id="ambrpf0sbuebelnpx9evjxd7t076x4yv">Pinterest icon</title>
                    ...
                    <div className="links-container">
                        <div className="links-column">
                            ...
                            <a className="link" href="/shots/19057350-Design-a-character-for-a-video-game">Weekly Warm-Up</a>
                        ...
                        <div className="links-column">
                            ...
                            <a target="_blank" rel="noopener" className="link" href="https://creativemarket.com/?utm_source=dribbble&utm_medium=referral&utm_campaign=footer">Creative
                                Market</a>
                            ...
                            <a target="_blank" rel="noopener" className="link" href="https://www.fontsquirrel.com/?utm_source=dribbble&utm_medium=referral&utm_campaign=footer">Font
                                Squirrel</a>
                        </div>
                        <div className="links-column">
                            ...
                            <a rel="noopener" className="link" href="https://www.industry-trends.dribbble.com">Design Industry
                                Trends</a>
                        </div>
                    </div>
                </div>
                <div className="footer-lower-content">
                    ...
                    <div className="total-shots-container">
                        <div>
                            <span className="shots-count">19,178,588</span>
                            shots dribbbled
                        </div>
                        <img className="dribbble-ball lazyload" data-src="https://cdn.dribbble.com/assets/dribbble-ball-icon-4e54c54abecf8efe027abe6f8bc7794553b8abef3bdb49cd15797067cf80ca53.svg" width="24px" height="24px" alt="Dribbble ball icon" />
                    </div>
                </div>
            </div>
        </div>
